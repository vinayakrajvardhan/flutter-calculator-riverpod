...
class MyApp extends StatelessWidget {
  static final String title = 'VINAYAK  CALCULATOR';
  ...
  Widget build(BuildContext context) => Scaffold(
        appBar: AppBar(
          ...
          title: Container(
            ...
            child: Text(widget.title,style: TextStyle(color: Colors.tealAccent),),
          ),
          actions: [
            Container(
              margin: EdgeInsets.only(right: 20.0),
              child: IconButton(
                icon: Icon(Icons.calculate_rounded,size: 40.0,color: Colors.tealAccent,),
                onPressed: () {},
              ),
            )
          ],
